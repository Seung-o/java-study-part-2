...
class MyGraph {
    private static final int UNLIMIT = 999999999;  // 초기값
    private final int count;   //노드 수
    private final int[][] vertexMatrix;  // matrix로 그래프 표시
    private final int[] distance;        // 특정 노드에 대한 각 노드의 최단 거리
    private final boolean[] visited;     // alread visited???
